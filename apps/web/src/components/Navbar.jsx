        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {isDropdownOpen && (
            <div ref={dropdownMenuRef} className="absolute right-0 mt-2 w-48 bg-[var(--card)] rounded-[var(--radius-md)] shadow-neu border border-[var(--border)] py-2 z-50 origin-top-right">
              ...
              <Link to="/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-[var(--text-primary)] hover:bg-[var(--bg)] transition-colors font-medium" onClick={() => setIsDropdownOpen(false)}>
